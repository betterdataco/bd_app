...
export function Footer() {
  const { domain = "betterdata.co" } = useParams() as { domain: string };

  const createHref = (href: string) =>
    domain === "betterdata.co" ? href : `https://betterdata.co${href}`;
  ...
  return (
    <footer>
      <MaxWidthWrapper className="relative z-10 overflow-hidden border border-b-0 border-gray-200 bg-white/50 pb-60 pt-16 backdrop-blur-lg md:rounded-t-2xl">
        ...
        <Image
          src="https://assets.betterdata.co/footer.png"
...
function StatusBadge() {
  ...
  }>("https://status.betterdata.co/api/v1/summary", fetcher);
  ...
  return (
    <Link
      href="https://status.betterdata.co"
      target="_blank"
