...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "app.betterdata.co";
...
export const DUB_LOGO = "https://assets.app.betterdata.co/logo.png";
export const DUB_THUMBNAIL = "https://assets.app.betterdata.co/thumbnail.jpg";
    ...
    ? [
        {
          ...
          archived: false,
          publicStats: false,
          target: "https://app.betterdata.co/tools/chatgpt-link-shortener",
          type: "redirect",
        ...
        },
        {
          ...
          archived: false,
          publicStats: false,
          target: "https://app.betterdata.co/tools/spotify-link-shortener",
          type: "redirect",
        ...
        },
        {
          ...
          archived: false,
          publicStats: false,
          target: "https://app.betterdata.co/tools/github-link-shortener",
          type: "redirect",
        ...
        },
        {
          ...
          archived: false,
          publicStats: false,
          target: "https://app.betterdata.co/tools/amazon-link-shortener",
          type: "redirect",
        ...
        },
        {
          ...
          archived: true,
          publicStats: true,
          target: "https://app.betterdata.co/tools/url-lengthener",
          type: "redirect",
