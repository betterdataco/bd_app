    ...
    <>
      ...
      {domainError &&
        (domainError === "Domain is already in use." ? (
          <p className="mt-2 text-sm text-red-600" id="domain-error">
            ...
            <a
              className="underline"
              href="mailto:support@betterdata.co?subject=My Domain Is Already In Use"
            >
              Contact us
            </a>{" "}
      ...
      {(domain.includes("/") || domainType === "website") && (
        <p className="mt-2 text-sm text-gray-500">
          Want to set up betterdata.co to handle redirects on a subpath instead?{" "}
          <a
            href="https://betterdata.co/help/article/how-to-use-dub-with-subpath"
            target="_blank"
            className="underline"
          >
            Read this guide.
