...
const BUSINESS_PLAN_MODIFIER = ({
  ...
  link: "https://betterdata.co/help/article/business-plan",
  price: {
    monthly,
    yearly,
    ids,
  ...
  cta: {
    ...
    href: "https://betterdata.co/register",
  ...
  features: [
    ...
    { text: `Unlimited AI credits` },
    {
      ...
      footnote: {
        ...
        cta: "Learn more.",
        href: "https://betterdata.co/help/article/how-to-use-tags",
      },
    },
...
export const PLANS = [
    ...
    features: [
      ...
      },
      {
        ...
        footnote: {
          ...
          cta: "Learn more.",
          href: "https://betterdata.co/docs/api-reference/introduction",
        },
      },
    ],
  },
  {
    ...
    link: "https://betterdata.co/help/article/pro-plan",
    price: {
      monthly: 24,
      yearly: 19,
      ids: [
    ...
    features: [
      ...
      { text: "Basic support", footnote: "Basic email support." },
      {
        ...
        footnote: {
          ...
          cta: "Learn more.",
          href: "https://betterdata.co/help/article/how-to-redirect-root-domain",
        },
      },
      {
  ...
  }),
  {
    ...
    link: "https://betterdata.co/enterprise",
    price: {
      monthly: null,
      yearly: null,
    },
