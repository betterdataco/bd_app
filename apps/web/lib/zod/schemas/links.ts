...
export const createLinkBodySchema = z.object({
  ...
  domain: z
    ...
    .optional()
    .describe(
      "The domain of the short link. If not provided, the primary domain for the workspace will be used (or `tagd.sh` if the workspace has no domains).",
    ),
  key: z
    .string()
    .optional()
  ...
  title: z
    ...
    .nullish()
    .describe(
      "The title of the short link generated via `api.betterdata.co/metatags`. Will be used for Custom Social Media Cards if `proxy` is true.",
    ),
  description: z
    .string()
    .nullish()
    .describe(
      "The description of the short link generated via `api.betterdata.co/metatags`. Will be used for Custom Social Media Cards if `proxy` is true.",
    ),
  image: z
    .string()
    .nullish()
    .describe(
      "The image of the short link generated via `api.betterdata.co/metatags`. Will be used for Custom Social Media Cards if `proxy` is true.",
    ),
  rewrite: z
    .boolean()
    .optional()
...
export const LinkSchema = z
  .object({
    ...
    shortLink: z
      ...
      .url()
      .describe(
        "The full URL of the short link, including the https protocol (e.g. `https://tagd.sh/try`).",
      ),
    qrCode: z
      .string()
      .url()
      .describe(
        "The full URL of the QR code for the short link (e.g. `https://api.betterdata.co/qr?url=https://tagd.sh/try`).",
      ),
    utm_source: z
      .string()
      .nullable()
