...
export function Footer() {
  ...
  const createHref = (href: string) =>
    domain === "app.betterdata.co" ? href : `https://app.betterdata.co${href}`;
  ...
  return (
    <footer>
      <MaxWidthWrapper className="relative z-10 overflow-hidden border border-b-0 border-gray-200 bg-white/50 pb-60 pt-16 backdrop-blur-lg md:rounded-t-2xl">
        ...
        <Image
          src="https://assets.app.betterdata.co/footer.png"
...
function StatusBadge() {
  ...
  }>("https://status.app.betterdata.co/api/v1/summary", fetcher);
  ...
  return (
    <Link
      href="https://status.app.betterdata.co"
      target="_blank"
